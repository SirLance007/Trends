...
const products = [
  {
    ...
    brand: "Urban Threads",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Red", "Blue", "Yellow", "Green"], // Red, Blue, Yellow, Green
  ...
  },
  {
    ...
    brand: "Modern Fit",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Black", "Blue", "Red", "Orange"], // Black, Blue, Red, Orange
  ...
  },
  {
    ...
    brand: "Street Style",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Blue", "SkyBlue", "Red", "Brown"], // Blue, SkyBlue, Red, Brown
    ...
    images: [
      ...
      {
        url: "https://images.unsplash.com/photo-1469398715555-76331a6c7b29?auto=format&fit=crop&w=500&q=80",
  ...
  },
  {
    ...
    brand: "Beach Breeze",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Gold", "Teal", "HotPink", "SteelBlue"], // Gold, Teal, HotPink, SteelBlue
  ...
  },
  {
    ...
    brand: "Urban Chic",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Black", "Gray", "Blue", "Green"], // Black, Gray, Blue, Green
  ...
  },
  {
    ...
    brand: "Polo Classics",
    sizes: ["S", "M", "L", "XL"],
    colors: ["White", "Navy", "Red", "LimeGreen"], // White, Navy, Red, LimeGreen
    collections: "Casual Wear",
    material: "Cotton",
    gender: "Men",
    images: [
  ...
  },
  {
    ...
    brand: "Street Vibes",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Black", "Gray", "Orange", "DarkTurquoise"], // Black, Gray, Orange, DarkTurquoise
  ...
  },
  {
    ...
    brand: "Heritage Wear",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Gray", "Olive", "Black", "Purple"], // Gray, Olive, Black, Purple
    collections: "Casual Wear",
    material: "Cotton Blend",
    gender: "Men",
    images: [
  ...
  },
  {
    ...
    brand: "Winter Basics",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Charcoal", "DarkGreen", "Navy", "Chocolate"], // Charcoal, DarkGreen, Navy, Chocolate
  ...
  },
  {
    ...
    sizes: ["S", "M", "L", "XL"],
    colors: ["White", "Black", "Navy", "DeepPink"], // White, Black, Navy, DeepPink
    collections: "Basics",
    material: "Cotton",
    gender: "Men",
    images: [
  ...
  },
  {
    ...
    brand: "ChicKnit",
    sizes: ["S", "M", "L"],
    colors: ["Beige", "White", "Pink", "Maroon"], // Beige, White, Pink, Maroon
  ...
  },
  {
    ...
    brand: "BohoVibes",
    sizes: ["S", "M", "L", "XL"],
    colors: ["White", "Pink", "Gold", "LightSeaGreen"], // White, Pink, Gold, LightSeaGreen
    collections: "Summer Collection",
    material: "Viscose",
    gender: "Women",
    images: [
  ...
  },
  {
    ...
    brand: "ComfyTees",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Black", "White", "Gray", "DeepSkyBlue"], // Black, White, Gray, DeepSkyBlue
  ...
  },
  {
    ...
    brand: "Elegance",
    sizes: ["S", "M", "L"],
    colors: ["Red", "White", "Blue", "PeachPuff"], // Red, White, Blue, PeachPuff
  ...
  },
  {
    ...
    brand: "DelicateWear",
    sizes: ["S", "M", "L"],
    colors: ["Black", "White", "LightPink", "Lavender"], // Black, White, LightPink, Lavender
  ...
  },
  {
    ...
    brand: "StreetStyle",
    sizes: ["S", "M", "L", "XL"],
    colors: ["White", "Black", "Gold", "SpringGreen"], // White, Black, Gold, SpringGreen
    collections: "Urban Collection",
    material: "Cotton",
    gender: "Women",
    images: [
  ...
  },
  {
    ...
    brand: "ComfortFit",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Gray", "Pink", "Brown", "SteelBlue"], // Gray, Pink, Brown, SteelBlue
  ...
  },
  {
    ...
    brand: "FeminineWear",
    sizes: ["S", "M", "L"],
    colors: ["White", "Navy", "Lavender", "Tomato"], // White, Navy, Lavender, Tomato
    collections: "Summer Collection",
    material: "Viscose",
    gender: "Women",
    images: [
  ...
  },
  {
    ...
    brand: "ClassicStyle",
    sizes: ["S", "M", "L", "XL"],
    colors: ["White", "LightBlue", "Black", "Gold"], // White, LightBlue, Black, Gold
  ...
  },
  {
    ...
    brand: "ChicWrap",
    sizes: ["S", "M", "L"],
    colors: ["Red", "Black", "White", "DarkTurquoise"], // Red, Black, White, DarkTurquoise
    collections: "Evening Collection",
    material: "Polyester",
    gender: "Women",
    images: [
